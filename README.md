...
Open in Google Colab: Upload the .ipynb file to Google Colab, or open it directly if you're viewing it on GitHub with Colab integration.
Upload Data Files: The notebook expects the data files (revenue_per_product.csv, revenue_per_customer.csv, categorywise performance.csv, orderTrend_monthly.csv) to be uploaded. Run the files.upload() cells to upload them.
Execute Cells: Run the cells sequentially to reproduce the analysis and visualizations.
Technologies Used
Python 3
